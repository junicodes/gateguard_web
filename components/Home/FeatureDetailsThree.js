...
const FeatureDetailsThree = () => {
    ...
    return (
        <>
            <div className="wrapper w-full flex flex-col md:flex-row lg:justify-evenly px-4 lg:px-5 pt-16 lg:pt-64 animate__animated animate__fadeIn">

                <div className="image-block items-center w-full mx-auto md:w-1/2 pt-10">
                    <StyledImage aos="fade-down-right" className="mx-auto" src="/images/home-page/feature-wallpaper-three.svg" />
                </div>
