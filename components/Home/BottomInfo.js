...
const BottomInfo = () => {
    ...
    return (
        <div className="wrapper w-full flex flex-col md:flex-row lg:justify-evenly px-4 lg:px-10 xl:px-24 pt-16 lg:pt-10 relative animate__animated animate__fadeIn">

            <div className="pt-20 md:pt-40 md:mt-0 item w-full md:w-1/2">
                ...
                <div className="flex justify-start sm:justify-center md:justify-start py-8">
                    <PrimaryBtn onEvent={() => router.push('/request-demo')} style={{width: '100%'}} className="primary_btn_large text-sm text-white justify-center font-bold lg:mt-0" label="Request a Demo" />
                </div>
            </div>

            <div className="items-center md:px-10 lg:px-0 w-full mx-auto md:w-1/2 pt-20 lg:pt-10 -mb-10 md:mt-0 md:pt-0 ">
