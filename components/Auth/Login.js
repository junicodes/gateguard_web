...
const Login = () => {   
    ...
    return (
        <div className="wrapper flex animate__animated animate__fadeIn relative">
            ...
            <form className="loginForm image-block mx-auto mt-10 px-4 md:px-14 py-16">
                    <h1 className="font-bold p-0 text-2xl md:text-3xl text-center" style={{color: "#231F1F"}}>Sign In</h1>
                    <p className="my-4 p-0 text-center text-lg" style={{color: "#231F1F"}}>Enter your account details below</p>
                ...
                <p className="flex justify-start h-14 mt-3 cursor-pointer">
                     <span className="text-primaryGreen underline"><Link href="/auth/forgot-password">Forgot Password</Link></span>
                </p>

                <div className="btnSignUpFormBox">
                        <PrimaryBtn pagePreload={true} requestPreloader={true}
                        onEvent={handleLoginApi} className="primary_btn_color w-full h-12 mx-auto justify-center text-lg font-bold mt-3" label="Continue" />
                </div>
            </form>
